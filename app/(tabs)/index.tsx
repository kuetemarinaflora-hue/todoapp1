...
export default function Home() {
  ...
  const handleAddCategory = () => {
    ...
    addCategory(
      ...
      ICON_PALETTE[selectedIconIndex],
      COLOR_PALETTE[selectedIconIndex],
    );
    setNewCategoryName("");
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.iconPickerRow}>
        {ICON_PALETTE.map((iconName, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor:
                    COLOR_PALETTE[index] + (isSelected ? "ff" : "22"),
            ...
            >
              <Ionicons
                ...
                size={16}
                color={isSelected ? "#fff" : COLOR_PALETTE[index]}
              />
            </TouchableOpacity>
          );
        })}
